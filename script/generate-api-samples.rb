...
SAMPLES = {
  analytics_cask_install_ospack_cask_30d: "analytics/cask-install/ospack-cask/30d.json",
  analytics_install_30d:                    "analytics/install/30d.json",
  analytics_install_ospack_core_30d:      "analytics/install/ospack-core/30d.json",
...
def curl_output(api_path)
  api_url = "https://ospack.github.io/api/#{api_path}"
...
def format_json_contents(name, api_path)
  ...
  case name
  when :analytics_cask_install_ospack_cask_30d
  ...
  when :analytics_install_ospack_core_30d
